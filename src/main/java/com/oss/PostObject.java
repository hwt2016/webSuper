...
public class PostObject {
    ...
    // 需要上传的本地文件，确保该文件存在
//    private String localFilePath = "D:\\111.png";
    // OSS域名，如http://oss-cn-hangzhou.aliyuncs.com
    private String endpoint = Constant.ENDPOINT;
    ...
    public void PostObject(String key,String localFilePath) throws Exception {
        // 提交表单的URL为bucket域名
    ...
    public static void post(String key,String qrcodePath) throws Exception {
        PostObject ossPostObject = new PostObject();
        ossPostObject.PostObject(key,qrcodePath);
    }
